...
/**
 * Test case for class WM\OpManager\Controller\CategoryController.
 *
 */
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \WM\OpManager\Controller\CategoryController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('WM\\OpManager\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView() {
		...
		$categoryRepository = $this->getMock('WM\\OpManager\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
